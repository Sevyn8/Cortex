...
- [ ] P1.2 F02 Tenant Lifecycle — IN FLIGHT (Slices A/B/C closed; Slice D in-flight)
  ...
  - [ ] Slice D — Key rotation + HTTP API + Cloud Run TF — IN FLIGHT (D.1 ✓ + D.2 ✓ + D.3 ✓ + D.4 ✓; next: D.5)
